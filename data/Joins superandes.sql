...
___
--- Tabla carrito
SELECT VENDECARRITO.IDPRODUCTO AS IDPRODUCTO, PRODUCTO.NOMBRE AS NOMBRE, vendecarrito.cantidadcarrito AS CANTIDAD, VENDE.PRECIO AS PRECIO, (VENDE.PRECIO * VENDECARRITO.CANTIDADCARRITO)AS SUBTOTAL
FROM((VENDECARRITO
